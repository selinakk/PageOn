...
<div class="position-relative padding-medium">
    <div class="container">
        ...
        <form action="/forum/insertOK.do" method="POST">
            <input type="hidden" name="num" id="num" value="4" placeholder="임시">
            <input type="hidden" name="work_num" id="work_num" value="124">
